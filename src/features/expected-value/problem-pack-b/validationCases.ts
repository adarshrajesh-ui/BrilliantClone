...
const repairCases: PackValidationCase[] = [
  ...
  { id: 'p11-correct-percent-whitespace', canonicalSlug: 'l3-repair-probability-table', description: 'percent + whitespace probability equivalents', input: repair(' 12.5% ', ' 37.5% ', ' 4 / 8 '), expectedCorrect: true, prdReason: 'Probability cells accept percent forms and mixed whitespace.' },
...
const prizeBagCases: PackValidationCase[] = [
  ...
  { id: 'p12-correct-fractional-numeric-fields', canonicalSlug: 'l3-prize-bag-ev-table', description: 'fraction counts, percent probabilities, fraction contributions/EV', input: prizeBag(['4/2', '20%', '6/2'], [' 6 / 2 ', '30%', '3/2'], ['10/2', '50%', '0/5'], '9/2'), expectedCorrect: true, prdReason: 'Counts, contributions, and EV accept equivalent numeric fractions; probabilities accept percent forms.' },
...
const payoutCases: PackValidationCase[] = [
  ...
  { id: 'p13-correct-fraction', canonicalSlug: 'l4-payout-vs-profit', description: 'profit as 2/2', input: payoutVsProfit(true, ' 2 / 2 '), expectedCorrect: true, prdReason: 'Equivalent fraction accepted for numeric profit.' },
...
const findFairCases: PackValidationCase[] = [
  ...
  { id: 'p15-correct-fractions', canonicalSlug: 'l4-find-fair-price', description: 'payout/cost/profit fractions', input: findFair('8/2', ' 12 / 3 ', '0/4', 'fair'), expectedCorrect: true, prdReason: 'Equivalent fractions accepted for all numeric fields.' },
...
const chooseCases: PackValidationCase[] = [
  ...
  { id: 'p16-correct-fractions', canonicalSlug: 'l4-choose-better-game-after-cost', description: 'profits as fractions', input: chooseGame('4/2', ' 9 / 3 ', 'Game B'), expectedCorrect: true, prdReason: 'Equivalent fractions accepted for both profit fields.' },
...
const wholeCases: PackValidationCase[] = [
  ...
  { id: 'p17-correct-percent-fractional-numeric-fields', canonicalSlug: 'l5-build-whole-ev-model', description: 'percent probabilities and fractional numeric fields', input: wholeModel(['10%', '20%', '70%'], ['6/2', '20/10', '0/7'], '10/2', '0/5', 'fair'), expectedCorrect: true, prdReason: 'Probabilities accept percent forms; contributions, payout, and profit accept equivalent fractions.' },
...
const sameEvCases: PackValidationCase[] = [
  ...
  { id: 'p18-correct-fraction-evs', canonicalSlug: 'l5-same-ev-different-risk', description: 'EVs as equivalent fractions', input: sameEv('10/2', '15/3', 'B', 'variable outcomes'), expectedCorrect: true, prdReason: 'EV fields accept equivalent fractions.' },
...
const lowHighCases: PackValidationCase[] = [
  ...
  { id: 'p19-correct-fraction-evs', canonicalSlug: 'l5-low-risk-vs-high-risk', description: 'EVs as equivalent fractions', input: lowHigh('12/2', '18/3', 'Game B', 'wider spread'), expectedCorrect: true, prdReason: 'EV fields accept equivalent fractions.' },
...
const capstoneCases: PackValidationCase[] = [
  ...
  { id: 'p20-correct-percent-fractional-numeric-fields', canonicalSlug: 'l5-final-capstone-ev-decision', description: 'percent probabilities and fractional numeric fields', input: capstone(['8.33%', '25%', '66.67%'], ['9/3', '12/4', '0/8'], '12/2', '0/6', 'fair', 'fair but variable'), expectedCorrect: true, prdReason: 'Probabilities accept percent forms; contributions, payout, and profit accept equivalent fractions.' },
